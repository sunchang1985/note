function love.conf(t)
	...
	t.author = "sunchang"				-- The author of the game (string)
	t.identity = "xxx"					-- The name of the save directory (string)
	t.console = true					-- Attach a console (boolean, Windows only)
	t.window.width = 480				-- The window width (number)
	t.window.height = 640				-- The window height (number)
	t.window.fullscreen = false			-- Enable fullscreen (boolean)
	t.window.vsync = true				-- Enable vertical sync (boolean/integer)
